        ...
        <div className='flex flex-col gap-4'>
          {filteredAppointments.map((app) => {
            ...
            return (
              <div
                key={app.id}
                className={`bg-card border border-border rounded-2xl p-5 sm:p-6 flex flex-col sm:flex-row gap-5 items-start justify-between transition-all ${
              ...
              >
                ...
                {/* Right: Actions */}
                <div className='flex sm:flex-col items-center sm:items-end gap-2 w-full sm:w-auto pt-3 sm:pt-0 border-t sm:border-t-0 border-border justify-end'>
                  {!isCancelled && (
                    <button
