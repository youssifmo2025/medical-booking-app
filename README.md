...
- **Favorite Doctors:** Users can toggle ❤️ on any doctor card. Favorites are managed via a dedicated Zustand store and persisted to `localStorage`, with a quick-filter button on the main page.
